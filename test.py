    ...
    with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
        with tf.get_default_graph().name_scope('generator'):
            ...
            for index, noise_layer in enumerate(init_noise[1:]):  # skip first
                ...
                low_conv3 = conv(low_conv2, current_channels, 1, 1, name='gen_low_conv{}_3'.format(index), activation='leaky_relu')
                ...
                high_conv3 = conv(high_conv2, 8, 1, 1, name='gen_high_conv{}_3'.format(index), activation='leaky_relu')
            ...
            result_conv3 = conv(result_conv2, 3, 1, 1, name='gen_result_3', activation='leaky_relu')
