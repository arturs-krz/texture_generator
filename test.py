...
# with tf.device('/cpu:0'):
    with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
        with tf.get_default_graph().name_scope('generator'):
            ...
            transp_1_1 = conv_transpose(single_noise, 8, 3, 2, name='gen_transp1_1')
            transp_1_2 = conv_transpose(transp_1_1, 16, 3, 2, name='gen_transp1_2')
            transp_1_3 = conv_transpose(transp_1_2, 16, 3, 2, name='gen_transp1_3')
            conv1_1 = conv(transp_1_3, 16, 3, 1, name='gen_conv1_1')
